...
from baseline.GAP_master.core.models.multi_mlp import MultiMLP
from baseline.GAP_master.core.modules.base import Metrics
from baseline.GAP_master.core.modules.node.cm import ClassificationModule
...
class GAP (NodeClassification):
    ...
    def test(self, data: Optional[Data] = None, prefix: str = '') -> Metrics:
        ...
        # test的时候一般就不会再进行特征编码了，因为train已经做过了，所以这里它进行判断，如果数据集不变，则不用编码
