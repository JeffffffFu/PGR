...
from baseline.PPRL.utils.train_utils import add_flags_from_config

config_args = {
    'training_config': {
        'algorithm':('train_with_PPRL','algorithm'),
        'attack': ('LinkTeller', 'attack'),
        ...
        'momentum': (0.9999, 'momentum in optimizer'),
    ...
    'model_config': {
        ...
        'alpha': (0.2, 'alpha for leaky relu in graph attention networks'),
    ...
    'data_config': {
        ...
        'split-seed': (3407, 'seed for data splits (train/test/val)'),
    }
}
